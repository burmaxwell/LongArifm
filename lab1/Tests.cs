    ...
    class Test
    {
        ...
        public class TestCalculation
        {
            ...
            public void ModTest(string hex1, string hex2, string expectedResult)
            {
                ...
                var actualResult = Program.ModSt(hex1, hex2);
                Assert.AreEqual(expectedResult, actualResult);
            }
            ...
            {
                var actualResult = Program.AddModSt(hex1, hex2, hex3);
                Assert.AreEqual(expectedResult, actualResult);
            }
            ...
            {
                var actualResult = Program.SubModSt(hex1, hex2, hex3);
                Assert.AreEqual(expectedResult, actualResult);
            }
            [Test]
            ...
            {
                var actualResult = Program.MulModSt(hex1, hex2, hex3);
                Assert.AreEqual(expectedResult, actualResult);
            }
            ...
            {
                var actualResult = Program.BarrettReductionSt(hex1, hex2);
                Assert.AreEqual(expectedResult, actualResult);
            }
            ...
            //[TestCase("240C873C5664D9929A9233CB0F8E1F19B61874A66BCB6AAA61C5A7110D6F7864", "E1076991258875E85E748A7DD3B4DBC8730B21149727E2F1416DDC803255CA70", "4E469842DC0E8EFF469429646F15074CA0A710653D88ED476036FFA23D170395", "DC046B9FB2B8D784F902C1E35BB1284738F1CE3234944987AED8044273C4C3C")]
            ...
            public void LongBarrettPowerSt(string hex1, string hex2, string hex3, string expectedResult)
            {
                var actualResult = Program.ModPowerSt(hex1, hex2, hex3);
                Assert.AreEqual(expectedResult, actualResult);
            }
